...
cv::Point findEyeCenter(cv::Mat eyeImage, cv::Rect eye, std::string debugWindow) {
    cv::Mat eyeROIUnscaled = eyeImage(eye);
    cv::Mat eyeROI;
    scaleToFastSize(eyeROIUnscaled, eyeROI);
    // draw eye region
    rectangle(eyeImage,eye,1234);
    //-- Find the gradient
